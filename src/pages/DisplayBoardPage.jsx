...
const BASE_COLUMN_SIZE = { doctor: 'text-2xl', patient: 'text-lg', now: 'text-lg', num: 'h-8 w-8 text-base' }
const columnSize = (colCount) => COLUMN_SIZE_TIERS[colCount] || BASE_COLUMN_SIZE
