...
export default function DeathCertificateModule() {
  ...
  const stats = certificatesPagination.summary || {
    total: 0,
    issued: 0,
    pendingIssuance: 0,
    maternal: 0,
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          <Button variant="ghost" onClick={() => setView("list")}>
            <X className="h-4 w-4 mr-1" /> Back to Directory
          </Button>
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-2xl font-bold">
            Edit Certificate: {cert?.certificateNumber}
          </h2>
        </div>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500">
            Official death record management and certification
          </p>
        </div>
        <Button
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="border-l-4 border-l-orange-500">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats.pendingIssuance}</div>
          </CardContent>
        </Card>
        <Card className="border-l-4 border-l-purple-500">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats.maternal}</div>
          </CardContent>
        </Card>
      </div>
              ...
              <TableRow key={cert.id}>
                ...
                <TableCell>
                  {cert.issuedAt ? (
                    ...
                    <Badge
                      variant="secondary"
                      className="bg-orange-100 text-orange-700 hover:bg-orange-100 w-fit"
                    >
                      Draft/Pending
                    </Badge>
                  )}
